...
try {
    const contact1 = new Contact('John', 'Doe', '1234 Elm St', 'New York', 'New York', '10001', '1234567890', 'john.doe@example.com');
...
// try {
//     const contact = new Contact('John', 'Doe', '1234 Elm St', 'New York', 'New York', '10001', '1234567890', 'john.doe@example.com');
//     addressBook.addUniqueContact(contact);
//     console.log('Total Contacts:', addressBook.countContacts());
//     addressBook.sortByName();
// } catch (error) {
//     console.error(error.message);
